...
public class MultiDragTouchHandler implements TouchHandler {
    private final EventSink eventSink;
    private List<TouchEvent.Pointer> lastTouches;

    public MultiDragTouchHandler(EventSink eventSink) {
    ...
    public void onTouchMove(TouchEvent.Pointer[] touches) {
        ...
        eventSink.onEvent(new Event.MultiTouchDrag(touchPoints));
        lastTouches = Arrays.asList(touches);
    }
